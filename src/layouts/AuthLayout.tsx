  ...
  return (
    <div className="h-screen overflow-hidden flex bg-background">
      ...
      <motion.aside
        ...
        // Anima a largura entre a versão "login" (proporcional) e "welcome" (sidebar fixa)
        animate={{ width: isLogin ? "47vw" : 380 }}
      ...
      {/* position:relative + absolute filhos = crossfade sem empurrar layout */}
