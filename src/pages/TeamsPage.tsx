    ...
    <div className="animate-fade-in space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {teams.map((team) => {
          ...
          return (
            <div key={team.id} className="bg-card border border-border rounded-lg p-6 hover:shadow-md transition-all">
              <div className="flex items-start justify-between mb-4">
                ...
                <span className="text-xs font-medium text-muted-foreground bg-muted px-2 py-1 rounded">{teamTasks.length} tarefas</span>
              </div>
              ...
              <div className="mb-4">
                ...
                <div className="h-1.5 bg-muted rounded-full overflow-hidden">
                  <div className="h-full bg-foreground rounded-full transition-all" style={{ width: `${teamTasks.length > 0 ? (completed / teamTasks.length) * 100 : 0}%` }} />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {team.members.map((member) => (
                    <div key={member} className="flex items-center gap-2 bg-muted/50 px-2.5 py-1.5 rounded-md">
