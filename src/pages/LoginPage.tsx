...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen p-3 md:p-6 flex items-stretch justify-center bg-background">
      <div className="w-full max-w-6xl min-h-[calc(100vh-1.5rem)] md:min-h-[calc(100vh-3rem)] overflow-hidden rounded-[28px] glass-panel grid grid-cols-1 lg:grid-cols-[0.92fr_1fr]">
        <section className="login-blue-panel text-white p-7 md:p-10 lg:p-12 flex flex-col justify-between min-h-[240px] lg:min-h-0">
          ...
          <p className="hidden lg:block text-sm text-white/70">© 2026 BuzzUp</p>
        </section>

        <section className="flex items-center justify-center px-6 py-10 md:px-12 bg-white/58">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      className="h-16 rounded-2xl pl-14 text-base bg-white/80"
                      autoFocus
                      required
                    />
                  </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      placeholder="••••••••"
                      className="h-16 rounded-2xl pl-14 pr-12 text-base bg-white/80"
                      minLength={6}
                      required
                    />
                    <button
