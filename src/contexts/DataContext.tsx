...
export function DataProvider({ children }: { children: ReactNode }) {
  const [teams] = useState<Team[]>(() => loadFromStorage("mktflow_teams", initialTeams));
  ...
  return (
    <DataContext.Provider value={{
      teams, projects, tasks, posts, events, generalItems, categories, channels: initialChannels,
